    ...
    <>
      ...
      <PageContent>
              ...
              <section className="mb-10 sm:mb-12">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3 text-gray-800">Акт приёмки и юридическая фиксация недостатков</h3>
                  <p className="text-base text-gray-700">
                    По результатам приёмки составляется акт приёмки с перечнем выявленных недостатков. Акт имеет юридическую силу, подтверждает состояние квартиры на момент осмотра и остаётся у вас на руках для предъявления застройщику и контроля устранения нарушений.
                  </p>
                </div>
              </section>
